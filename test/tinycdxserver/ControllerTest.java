...
public class ControllerTest {
    ...
    public void test() throws Exception {
        controller.handle(new DummySession(POST, "/test").data("- 20050614070159 http://nla.gov.au/ text/html 200 AKMCCEPOOWFMGGO5635HFZXGFRLRGWIX - 337023 NLA-AU-CRAWL-000-20050614070144-00003-crawling016.archive.org\n- 20030614070159 http://example.com/ text/html 200 AKMCCEPOOWFMGGO5635HFZXGFRLRGWIX - - - 337023 NLA-AU-CRAWL-000-20050614070144-00003-crawling016.archive.org\n"));
        controller.handle(new DummySession(POST,"/test").data("- 20060614070159 http://nla.gov.au/ text/html 200 XKMCCEPOOWFMGGO5635HFZXGFRLRGWIX - - - 337023 NLA-AU-CRAWL-000-20050614070144-00003-crawling016.archive.org\n- 20040614070159 http://example.com/ text/html 200 AKMCCEPOOWFMGGO5635HFZXGFRLRGWIX - - - 337023 NLA-AU-CRAWL-000-20060614070144-00003-crawling016.archive.org\n"));
        {
            NanoHTTPD.Response response = controller.handle(new DummySession(GET, "/test").parm("url", "nla.gov.au"));
        ...
        {
            NanoHTTPD.Response response = controller.handle(new DummySession(GET, "/test").parm("q", "type:urlquery url:http%3A%2F%2Fnla.gov.au%2F limit:2 offset:0"));
            String data = readOutput(response);
